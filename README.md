...
目前，ClipLink 已实现文本、链接、代码片段、密码、富文本、历史记录、收藏、搜索、通道管理和重复内容清理等核心网页端能力。我们计划在未来版本中逐步实现以下功能（按实现难度从易到难排序）：
...
| 图片/文件内容同步 | 📅 计划中 | 当前仅保留 image/file 类型枚举和路线图，后续补齐真实上传、下载、预览和跨设备同步 |
