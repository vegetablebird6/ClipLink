...
var messages = map[string]map[string]string{
	"zh-CN": {
		...
		"error.invalid_device_type":     "无效的设备类型",
		"error.invalid_clipboard_type":  "无效的剪贴板类型",
		"error.invalid_content_format":  "无效的内容格式",
		"error.device_id_required":      "设备 ID 不能为空",
		"error.search_keyword_required": "搜索关键词不能为空",
	...
	"en-US": {
		...
		"error.invalid_device_type":     "Invalid device type",
		"error.invalid_clipboard_type":  "Invalid clipboard type",
		"error.invalid_content_format":  "Invalid content format",
		"error.device_id_required":      "Device ID is required",
		"error.search_keyword_required": "Search keyword is required",
